...
class TeacherSignupRequestValidatorImpl(
    ...
    private fun rejectIfBlank(value: String, errors: MutableList<ValidationError>, field: String) {
        if (value.isBlank()) errors.add(ValidationError.FieldIsBlank(field))
    }

    private fun rejectIfTooLong(value: String, maxLength: Int, errors: MutableList<ValidationError>, field: String) {
