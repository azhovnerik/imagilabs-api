        ...
        with(preferences) {
            emailService.sendAsync(
                ...
                Please note the following:
                    1. The invitation can only be accepted on a web browser.
                    2. In order to access this classroom you need an imagi Edu Pro account linked to this email address.
